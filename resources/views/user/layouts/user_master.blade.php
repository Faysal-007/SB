...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        <a href="{{route('public_home')}}" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0 text-primary"><i class="fa fa-book me-3"></i>Service BD</h2>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="{{route('public_home')}}" class="nav-item nav-link active">Home</a>
            ...
            @if(Route::has('login'))
            @auth
            <a href="{{route('admin_dashboard')}}" class="btn btn-primary py-4 px-lg-5 d-none d-lg-block cu-01">Dashboard</a>
            ...
            @else
            <a href="{{route('login')}}" class="btn btn-primary py-4 px-lg-5 d-none d-lg-block cu-01">Login</a>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="row g-2 pt-2">
                        <div class="col-4">
                            <img class="img-fluid bg-light p-1" src="{{asset('user/assets/img/course-1.jpg')}}" alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid bg-light p-1" src="{{asset('user/assets/img/course-2.jpg')}}" alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid bg-light p-1" src="{{asset('user/assets/img/course-3.jpg')}}" alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid bg-light p-1" src="{{asset('user/assets/img/course-2.jpg')}}" alt="">
                        </div>
